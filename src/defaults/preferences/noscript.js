...
pref("noscript.surrogate.2mdn.replacement", "let _f=function(){};google=$S();Object.defineProperty(google,'__noSuchMethod__',{configurable:true,enumerable:false,value:_f});let _ima=new Proxy(typeof ima==='undefined'?{}:ima,{get:function(p,q){return q in p?p[q]:_f}});_ima.AdsManagerLoadedEvent=_ima.AdErrorEvent={Type:new Proxy({},{get:function(){return 0}}),};_ima.settings=new Proxy({},{get:function(){return _f}});_ima.ImaSdkSettings=new Proxy({},{get:function(t,x){return x in t?t[x]:_f}});_ima.AdsRequest=_ima.AdDisplayContainer=function(){return new Proxy({},{get:function(){return _f}});};_ima.common=new Proxy({},{get:function(){return _f}});_ima.video={client:new Proxy({},{get:function(t,x){return x in t?t[x]:_f}})};_ima.ViewMode=new Proxy({},{get:function(a,b){return b.toLowerCase();}});_ima.AdsLoader=_ima.getSettings=function(){return _ima};google.ima=window.ima=_ima;");
